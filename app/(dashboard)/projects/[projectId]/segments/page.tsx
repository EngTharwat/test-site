    ...
    <div className="p-6 md:p-8 max-w-7xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="text-center py-16 border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-2xl">
          ...
          <p className="text-[12px] text-[#6B7280] dark:text-gray-400">Add pipe segments with their engineering data and GIS coordinates.</p>
        </div>
      ) : (
          ...
          <table className="w-full text-[12px]">
            <thead>
              <tr className="bg-[#F3F4F6] dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                <th className="text-left px-4 py-3 text-[10px] font-bold text-[#6B7280] dark:text-gray-400 uppercase tracking-wider">Zone</th>
                <th className="text-left px-4 py-3 text-[10px] font-bold text-[#6B7280] dark:text-gray-400 uppercase tracking-wider">Line</th>
                <th className="text-left px-4 py-3 text-[10px] font-bold text-[#6B7280] dark:text-gray-400 uppercase tracking-wider">MH From → To</th>
                <th className="text-right px-4 py-3 text-[10px] font-bold text-[#6B7280] dark:text-gray-400 uppercase tracking-wider">Ø (mm)</th>
                <th className="text-right px-4 py-3 text-[10px] font-bold text-[#6B7280] dark:text-gray-400 uppercase tracking-wider">Length (m)</th>
                <th className="px-4 py-3 text-[10px] font-bold text-[#6B7280] dark:text-gray-400 uppercase tracking-wider">Material</th>
                {ACTIVITY_KEYS.map(a => (
                  <th key={a.key} className="px-2 py-3 text-[10px] font-bold text-[#6B7280] dark:text-gray-400 uppercase tracking-wider text-center">{a.label.slice(0,4)}</th>
                ))}
                <th className="text-right px-4 py-3 text-[10px] font-bold text-[#6B7280] dark:text-gray-400 uppercase tracking-wider">Overall</th>
            ...
            <tbody className="divide-y divide-gray-50 dark:divide-gray-800">
              {displayed.map(seg => (
                <tr key={seg.id} className="hover:bg-[#F9FAFB] dark:hover:bg-gray-800/50 transition-colors">
                  <td className="px-4 py-3 text-[#374151] dark:text-gray-300">{zoneMap[seg.zoneId] || '—'}</td>
                  ...
                  <td className="px-4 py-3">
                    <span className="bg-gray-100 dark:bg-gray-700 text-[#374151] dark:text-gray-300 text-[10px] font-semibold px-1.5 py-0.5 rounded">{seg.material}</span>
                  </td>
                  {ACTIVITY_KEYS.map(a => (
